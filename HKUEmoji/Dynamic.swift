...
class Dynamic: UIViewController {
	...
	func tapHandler1(sender: UITapGestureRecognizer) {
		...
		let image1 = addFaceToBackGround(faceBound, backgroundImage: UIImage(named: "hou2.png")!, faceImage: faceImage!)
		let image2 = addFaceToBackGround(faceBound, backgroundImage: UIImage(named: "hou5.png")!, faceImage: faceImage!)
	...
	func tapHandler2(sender: UITapGestureRecognizer) {
		...
		let image2 = addFaceToBackGround(faceBound, backgroundImage: UIImage(named: "hou3.png")!, faceImage: faceImage!)
		gifImage.animationImages?.append(image1)
		gifImage.animationImages?.append(image2)
